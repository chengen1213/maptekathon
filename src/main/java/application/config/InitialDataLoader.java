...
public class InitialDataLoader implements
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        createSuperUserIfNotFound("admin", Arrays.asList(adminRole));

        alreadySetup = true;
    }

    @Transactional
    protected User createSuperUserIfNotFound(String name, Collection<Role> adminRole) {
        ...
        if (user == null) {
            ...
            user.setEmail("a0955105@gmail.com");
